...
def build_parser() -> argparse.ArgumentParser:
    ...
    sources_answer.add_argument("--mode", choices=["keyword", "semantic", "hybrid"], default=None)
    ...
    sources_answer_matrix.add_argument("--mode", choices=["keyword", "semantic", "hybrid"], default=None)
