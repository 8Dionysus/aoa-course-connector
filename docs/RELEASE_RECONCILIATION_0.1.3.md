...
tree. It is regenerated through the separately pinned repo-local action
snapshot `6a79e62c7d20b6b11406dee78f409ada4a51bb3f` and checked for sentinel,
full-family, budget, contract, and compatibility parity. The provider release
pin remains the independent published `aoa-kag v0.5.2` identity; the action
snapshot is not substituted for that provider. The output does not replace
authored Course source authority.

For this successor, that action-compatible v3 route produced family digest
`ad998d593d3cef99ef1610c387e6d805ee4a97e9dcf85f0218c408d8767dd141`, with
`950377` changed generated bytes across `41` files, `288` shards, and
`5276963` tracked generated bytes. The owner budget receipt is
`kag/receipts/index_family_budget/ad998d593d3cef99ef1610c387e6d805ee4a97e9dcf85f0218c408d8767dd141.json`;
the delta remains below the `1048576` byte default limit. The exact action
sentinel, full DAG, family contract, and compatibility assembly all passed.
