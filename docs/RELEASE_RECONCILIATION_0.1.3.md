...
For this successor, the preserved repository action-compatible v3 route
produced family digest
`4a926d6ad4c3f6285002a066c352c886b9ca70ecc34053ba62ee20d0cb4db03e`, with
`927485` changed generated bytes across `41` files, `288` shards, and
`5277411` tracked generated bytes. The owner budget receipt is
`kag/receipts/index_family_budget/4a926d6ad4c3f6285002a066c352c886b9ca70ecc34053ba62ee20d0cb4db03e.json`;
the delta remains below the `1048576` byte default limit. The exact KAG
