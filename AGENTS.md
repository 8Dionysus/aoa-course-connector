...
PYTHONPATH=src python -m aoa_course_connector.cli preflight connected-plan --platform getcourse --platform stepik --live-scope bounded --write-runbook "$AOA_COURSE_ARTIFACT_ROOT/connected-source-runbook.md"
